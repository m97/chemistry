...
minetest.register_craft({
	...
	recipe = {
		{'technic:copper_wire', 'technic:logic_unit', 'technic:copper_wire'},
		{'chemistry:test_tube', 'default:steel_block', 'chemistry:test_tube'},
...
register_LV_machine ("chemistry_distiller_active","RE")